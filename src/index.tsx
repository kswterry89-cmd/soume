...
<section class="hero" id="top">
  ...
  <div class="hero-slides" id="heroSlides">
    <div class="hero-slide active" data-slide="0">
      <img src="https://www.genspark.ai/api/files/s/CZY0pdT1" alt="Soumé Campaign — Aesthetics of Emptiness" />
    </div>
    <div class="hero-slide" data-slide="1">
      <img src="https://www.genspark.ai/api/files/s/f3uv3pkz" alt="Soumé Campaign — Product Shot" />
    </div>
    <div class="hero-slide" data-slide="2">
      <img src="https://www.genspark.ai/api/files/s/K4RqE23o" alt="Soumé Campaign — Ocean Breeze" />
    </div>
    <div class="hero-slide" data-slide="3">
      <img src="https://www.genspark.ai/api/files/s/Wo9PUY7v" alt="Soumé Campaign — Product Shot" />
    </div>
  </div>
  ...
  <div class="hero-nav" id="heroNavPanel">
    <button class="hero-nav-item active" onclick="goSlide(0)">
      <div class="hero-nav-info">
        <span class="hero-nav-name">Aesthetics</span>
        <span class="hero-nav-role">of Emptiness</span>
      </div>
      <img class="hero-nav-thumb" src="https://www.genspark.ai/api/files/s/CZY0pdT1" alt="Aesthetics of Emptiness" />
    </button>
    <button class="hero-nav-item" onclick="goSlide(1)">
      <div class="hero-nav-info">
        <span class="hero-nav-name">Product</span>
        <span class="hero-nav-role">Campaign 01</span>
      </div>
      <img class="hero-nav-thumb" src="https://www.genspark.ai/api/files/s/f3uv3pkz" alt="Product Campaign 01" />
    </button>
    <button class="hero-nav-item" onclick="goSlide(2)">
      <div class="hero-nav-info">
        <span class="hero-nav-name">Ocean Breeze</span>
        <span class="hero-nav-role">Campaign</span>
      </div>
      <img class="hero-nav-thumb" src="https://www.genspark.ai/api/files/s/K4RqE23o" alt="Ocean Breeze" />
    </button>
    <button class="hero-nav-item" onclick="goSlide(3)">
      <div class="hero-nav-info">
        <span class="hero-nav-name">Product</span>
        <span class="hero-nav-role">Campaign 02</span>
      </div>
      <img class="hero-nav-thumb" src="https://www.genspark.ai/api/files/s/Wo9PUY7v" alt="Product Campaign 02" />
    </button>
  </div>
...
<section class="models" id="models">
  ...
  <div class="models-panorama r">
    <div class="model-panel">
      <img src="https://www.genspark.ai/api/files/s/CZY0pdT1" alt="Soumé Campaign Visual" />
      <div class="model-panel-overlay"></div>
      <div class="model-panel-badge">Campaign 2025</div>
      <div class="model-panel-info">
        <span class="model-panel-tag">Campaign Visual</span>
        <h3 class="model-panel-name">Pure Essence<br/>Campaign</h3>
        <p class="model-panel-desc">클린뷰티의 본질을 표현한 플래그십 캠페인</p>
      </div>
    </div>

    <div class="model-panel">
      <img src="https://www.genspark.ai/api/files/s/f3uv3pkz" alt="Product Campaign 01" />
      <div class="model-panel-overlay"></div>
    ...
    <div class="model-panel">
      <img src="https://www.genspark.ai/api/files/s/K4RqE23o" alt="Campaign Editorial" />
      <div class="model-panel-overlay"></div>
      <div class="model-panel-badge">Editorial</div>
      <div class="model-panel-info">
        <span class="model-panel-tag">Beauty Editorial</span>
        <h3 class="model-panel-name">청명함<br/>에디토리얼</h3>
        <p class="model-panel-desc">순수함으로 표현하는 클린뷰티</p>
      </div>
    </div>

    <div class="model-panel">
      <img src="https://www.genspark.ai/api/files/s/Wo9PUY7v" alt="Product Campaign 02" />
      <div class="model-panel-overlay"></div>
    ...
    <div class="about-grid">
      ...
      <div class="about-visual r d2">
        <div class="about-img-wrap">
          <img src="https://www.genspark.ai/api/files/s/K4RqE23o" alt="Soumé — Ocean Breeze" />
        </div>
...
<script>
  ...
  const slideTexts = [
    { headline: '피부가 원하는<br/><em>단 하나의 선택</em>', sub: '순수함의 미학으로 표현한<br/>클린뷰티의 정의. 유효 성분 그 자체로 충분합니다.' },
    { headline: 'Ocean Breeze<br/><em>Essence</em>',     sub: '상큼한 오션 향이 나는 프리미엄 에센스.<br/>유효 성분으로 표현되는 럭셔리한 경험.' },
    { headline: '청명함의<br/><em>새로운 기준</em>',     sub: '순수한 피부로 표현되는 진정한 아름다움.<br/>복잡하지 않은 케어, 눈에 보이는 변화.' },
    { headline: 'Soumé의<br/><em>모든 것</em>',    sub: '유효 성분을 담은 프리미엄 제품들.<br/>당신의 피부를 위한 완벽한 선택.' }
  ];
